...
In this homework, you will design a Java application using basic Java-GUI, that simulates a check-out of a supermarket (roughly the same as assignment-1, please review the instructions of assignment-1).
Forum Discussion: HW2 (please use the forum for questions).
